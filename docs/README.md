...
- The [Initial Placement Seed 133-document path-migration readiness audit](documentation-ia-seed-133-path-migration-readiness-audit1.md) verifies the three LiaisonScape manifests and reference/provenance risks; it is preparation only and authorizes no moves.
