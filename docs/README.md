...
- [Explicit Auto Layout / Pin Claim Reconciliation Preparation 1](roadmap-hybrid-reconstruction-explicit-auto-layout-pin-claim-reconciliation-preparation1.md): claim-level B/A/HOLD preparation for the mixed Roadmap planning-to-acceptance sequence; no Roadmap or History reconstruction is authorized.
