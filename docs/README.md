...
- [Documentation IA](documentation-ia/README.md) now holds repository documentation-governance records; the [Wave 5 result](documentation-ia/documentation-ia-wave5-final-residual-placement-migration1-result.md) records the four approved path-migration cohorts and the actual 70-file root census. The [root-ingress gate design](documentation-ia/documentation-ia-final-root-classification-and-ingress-gate-audit1.md) remains unimplemented pending Human review of the post-migration set and two retained HOLD records.
