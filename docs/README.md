...
- The bounded [Capability / Dataset Handoff evidence Wave 2A migration](documentation-ia-handoff-evidence-wave2-path-migration1-result.md) moved 13 records across the Cross-App, NarrativeLine, and LiaisonScape zones without merging their status or authority. The separate Validator 0.4.0 candidate remains in the [Wave 2 preparation](documentation-ia-application-workstream-foldering-wave2-preparation1.md).
