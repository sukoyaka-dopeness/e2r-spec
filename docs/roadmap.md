...
| History 2 bounded Stable registration | **DESIGN COMPARISON COMPLETE / HUMAN DECISION REQUIRED** | [Option 2 / Option 3 decision preparation](history-2-stable-registration-option2-option3-decision-preparation-result.md); Feature-level maturity, a new Stable identity/version, or continued Candidate status must be selected before sample migration |
