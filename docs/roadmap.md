...
| NarrativeLine pre-public feature candidates | **CONTENT / SAMPLE / PROVENANCE AUDIT COMPLETE / HUMAN RELEASE-SET DECISIONS REQUIRED** | [candidate audit](e2r-narrativeline-pre-public-feature-candidate-audit1-result.md) and [content/sample/provenance audit](e2r-initial-public-release-content-sample-provenance-refresh-audit1-result.md): guide refresh is bounded, but representative samples, rights, Self-Description placement, and public release set remain Human decisions; no new runtime feature is authorized |
